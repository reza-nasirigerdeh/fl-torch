...
with learning rate of 0.01, and batch size of 32 for 100 communication rounds, in a cross-silo federated environment
with 10 clients, 4 labels per client (relatively non-iid), and balanced sample size distribution:

```
python3 simulate.py --approach fedavg --dataset cifar10 --model vgg6_nn --optimizer sgd --momentum 0.0 \
                    --loss cross_entropy --learning-rate 0.01 --batch-size 32 --rounds 100 \
                    --clients 10 --classes-per-client 4 --balance-degree 1.0
